					...
					>
						...
						>
							<v-textarea
								...
								value="1.При нахождении квадратного корня числа 2-й операнд не требуется.																											2.При нахождении значения дроби (1/x) 2-й операнд не требуется.
	3.Значение Фибоначчи указано как сумма чисел Фибоначчи, вычисленных от значений операндов.
	4.Значение каждого операнда соответствует порядковому номеру определенного числа в числовом ряде Фибоначчи, т.е. числовой ряд Фибоначчи можно представить в виде массива, в котором значение операнда является индексом определенного значения в массиве."
							></v-textarea>
						</v-col>
					</v-row>
				</v-containe>
