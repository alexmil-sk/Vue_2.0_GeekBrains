	...
	<div class="card">
		...
		>
			<ul class="mt-4">
				...
				<v-btn class="mr-2" color="accent" elevation="12" large><router-link to="/vappdb/Food?value=200">Затраты "FOOD" </router-link></v-btn>
				<v-btn class="mr-2" color="accent" elevation="12" large><router-link to="/vappdb/Transport?value=50">Затраты "Transport" </router-link></v-btn>
				<v-btn class="mr-2" color="accent" elevation="12" large><router-link to="/vappdb/Entertainment?value=2000">Затраты "Entertainment" </router-link></v-btn>
